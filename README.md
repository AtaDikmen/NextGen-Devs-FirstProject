...
- Oyun Senaryosu
    ...
    * Alliance Command, medeniyetin çöküşü sonrası modern teknolojinin kaybolduğu, harabe şehirler ve vahşi doğanın hakim olduğu bir dünyada geçer. Oyuncular, terk edilmiş binaların ve tehlikeli ormanların arasında hayatta kalmak için mücadele ederken, aynı zamanda merkez üslerini düşman saldırılarından korumak zorundadır.
 
- Oyunun Amacı

    * Oyuncuların oyundaki ana hedefleri arasında hayatta kalmak ve ekibini geliştirmek, kaynakları toplamak ve etkin bir şekilde yönetmek, merkez üssünü güçlendirmek ve düşman saldırılarına karşı savunmak, stratejik kararlar alarak düşmanları alt etmek ve ekibini büyütüp zafere ulaşmak yer alır.
...
- **Hareket**
  ...
  * **Nasıl Çalışır?:** Oyuncu, karakterini hareket ettirmek istediğinde parmağını ekranın herhangi bir yerine dokunarak basılı tutar ve ardından parmağını ekranda istediği yöne sürükler. Karakter, parmağın hareket ettiği yönde ve hızda ekranda ilerler. Parmağını bıraktığında karakter durur veya mevcut pozisyonunu korur. Bu mekanik, oyunculara anında ve hassas kontrol imkanı sunar, böylece hızlı refleks gerektiren durumlarda veya stratejik hareketlerde avantaj sağlar.

- **Hızlı Koşma**
  
  * **Detaylar:** Hızlı koşma mekaniği, oyuncuların kısa süreliğine hızlarını artırmalarına olanak tanır. Bu özellik, oyun içinde stratejik hareket kabiliyetini artırmak ve düşmanlardan kaçmak veya hızlıca pozisyon almak için kullanılır. 

  * **Nasıl Çalışır?:** Oyuncu, ekranın alt kısmında bulunan ayakkabı butonuna bastığında karakteri belirli bir süre boyunca normal hızının iki katı hızda koşar. Bu süre tamamlandığında karakter tekrar normal hızına döner ve buton belirli bir süre boyunca yeniden dolana kadar kullanılamaz.

- **Saldırı**
  
  * **Detaylar:** Saldırı mekaniği oyuncunun elindeki silahın ve sahip olduğu ekip üyelerinin özelliklerine göre otomatik olarak gerçekleşir. 

  * **Nasıl Çalışır?:** Oyuncu, saldırmak istediği düşmanın bulunduğu alana yaklaşınca saldırı otomatik olarak başlar.

- **Düşman Dalgaları**
  
  * **Detaylar:** Düşman dalgaları, oyuncuların belirli aralıklarla gelen düşman dalgalarına karşı üslerini savunmalarını gerektirir. Her dalga belirli sayıda ve güçte düşmandan oluşur.

  * **Nasıl Çalışır?:** Oyuncu, her düşman dalgası başlamadan önce savunma stratejisini belirler ve ekibinin anlık özelliklerine ve yaklaşan düşmanlara göre uygun pozisyon alır. Düşman dalgaları belirli aralıklarla üsse saldırır ve oyuncunun ekibi bu saldırıları püskürtmek için otomatik olarak savunma pozisyonuna geçer. Her başarılı savunmanın sonunda oyuncu ekibe yeni üyeler katmak ve kaynak toplamak için merkez üssünden ayrılabildiği, sınırlı bir süreye sahip olur.

    <p align="center">
    <img width="872" height="427" src="https://github.com/user-attachments/assets/bb2edb0c-bc45-41fd-b7ec-3e0ed5c77113">
    <br>
    <i> Düşman Dalgaları </i>
    </p>

- **Ekibe Üye Ekleme**
  
  * **Detaylar:** Oyuncular, oyun boyunca karşılaştıkları ve kurtardıkları karakterleri ekiplerine ekleyebilirler. Bu yeni üyeler, oyuncunun yanında hareket eder ve savaşlarda aktif rol alır. Eğer ekibe  aynı karakter türünden üç adet dahil edilirse bu üç üye birleşir ve daha gelişmiş özellikli, daha büyük tek bir bireye otomatik olarak dönüşür.

  * **Nasıl Çalışır?:** Kurtarılan her karakter, otomatik olarak oyuncunun ekibine katılır ve oyuncunun kontrol ettiği ana karakteri takip eder. Bu yardımcı karakterler, düşmanlarla otomatik olarak savaşır ve oyuncunun stratejik komutlarına uygun hareket ederler. Ekip üyeleri, ana karakterin hareketlerini ve saldırılarını destekler.

    <p align="center">
    <img width="872" height="427" src="https://github.com/user-attachments/assets/46734cf4-ff0c-486c-9b1d-86af5ffe55cf">
    <br>
    <i> Ekibe Üye Ekleme </i>
    </p>

- **Ağaç Kesme**
  
  * **Detaylar:** Oyuncular, merkez üslerindeki kuleleri inşaa edebilmek için odun toplamak zorundadırlar. Odunlar yalnızca oyun alanındaki ağaçlardan toplanabilir.

  * **Nasıl Çalışır?:** Oyuncu bir ağacın yanına geldiğinde ve durduğunda ağaç kesme işlemi otomatik olarak başlar. Oyuncu o bölgeden ayrılana veya ağaç tamamen kesilene kadar kesme işlemi devam eder.

- **Kule İnşaası**
  
  * **Detaylar:** Merkez üslerindeki kulelerin inşaa edilmesi ile birlikte oyuncu ve ekibi kalıcı pasif özellikler kazanır. 
...
- **Ana Karakter**
    ...
    **General:** Oyuna pistol ile başlar. Kullanacağı silahı ana üsden açılan menüden satın alabilir, silahlar arasında geçiş yapabilir. General can kaybından dolayı ölürse oyun baştan başlar.
    <p align="center">
    <img width="385" height="317.8" src="https://github.com/user-attachments/assets/cef85e74-6b12-4547-b6df-9e41840e1ec9">
    </p>
...
- Pasif özellikler üs çevresindeki kuleler aracılığıyla sağlanır. Oyun başladığında kuleler yıkılmış halde bulunur ve restore edilmeleri gerekir. Kulelerin restore edilmesi için "coin" kaynağı kullanılır. Oyuncu yeterli coin’e sahipse kulenin önündeki işaretli alanda 2 saniye durduğunda kuleyi açmak için bir onay ekranı görünür.
  ...
  - **Demirci Kulesi (100 odun 5 altın):** Tamamlandığında tüm grup kalıcı +3 saldırı hızı bonusu kazanır.
